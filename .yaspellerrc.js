module.exports = {
  ...
  dictionary: [
    ...
    "запускатель",
    "затратно|затратнее",
    "Змиевски|Мэлин|Баккен|Стиг|Сураски|Гутманс|Лердорф.*|Хэнстридж|Кромману|Виеброка|Картуса|Аткинсона|Диффи|Хеллмана|Мерсена|Кастаноли|Анилу|Тишрей|Элул|Нейгла|Игелем|Редмиллером|Хаскиным|Фальманом|Крокфорда|Хилмана|Киссенджера|Фридла|Боллинджера|Апмсер|Хэйсэй|Блэкмана|Синк|Леманном|Клавиусом|Алоизием|Лилиусом|Мадхавапедди|Хэйз|Маллет|Мерсенна|Мерсена|Микио|Хирабаяши|Такури|Лавато|Кэти",
    "имитовставк.*",
    "иммутабельн.*",
    "инвалидац.*",
    "инжинеринг.*",
    ...
    "проприетарност.*",
    "прослушивател.*",
    "псевдо(объект|массив|тип|терминал|изображени).*",
    "пул.*",
    "пуш.*",
    "радиокнопк.*",
    "разблокируется",
