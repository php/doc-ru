...
Одного уточнения хватит, если в предложении или абзаце термин встречается больше одного раза, по смыслу.
При добавлении слова, которое уточняет термин, дайте точное определение. Для термина `$_SERVER` доступны
